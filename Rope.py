...
async def on_message(message):
    ...
    if message.author == discordClient.user:
        ...
        await discordClient.change_nickname(discord.utils.get(message.server.members, name=discordClient.user.name), "[Hangouts] {0}".format(message.author.display_name))
